    ...
    $(document).ready(function() {
        ...
        if($('#lgx-typed-string').length){
            $('#lgx-typed-string').typed({
                strings: ["eNigeria Conference 2018", "eNigeria Conference 2018","You learn Advance"],
                // typing speed
                typeSpeed: 10,
...
function setup(){
    loadJSON(" https://enigeria-staging-api.herokuapp.com/enigeria/v1/attendee", gotData, 'json');
